...
export const fonts = `ui-rounded, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Helvetica, sans-serif`
...
const theme = {
  ...
  fonts: {
    ...
    heading: `ui-rounded,Nunito,${fonts}`,
    body: `${fonts}`,
  },
  lineHeights: {
    limit: 0.875,
