    ...
    <Container sx={{ py: [4, 6] }}>
      ...
      <Grid columns={[1, null, 3]} gap={[3, 3, 3]}>
        ...
        <Card
          ...
          answer={
            <>
              We're here to help, ask them to reach out to us at <a style={{ color: 'black' }} href="mailto:assemble@hackclub.com">assemble@hackclub.com</a> and we'll make sure to answer all their questions.
            </>
          }
        />
