      ...
      >
        ...
        <Flex sx={{ flexDirection: ['column', 'column', 'row'] }}>
          ...
          >
            ...
            <Link sx={{color: 'white', fontWeight: 400, display: 'flex', mt: '5px'}} href="https://hackclub.com/slack" target="_blank">BTW: We're hanging out here until we meet IRL → <Icon glyph="slack" sx={{width: ['16px', '24px'], height: ['16px', '24px']}}/></>
          </Box>
        </Flex>
        <Button
        as="a"
